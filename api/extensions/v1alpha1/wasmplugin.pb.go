...
const file_extensions_v1alpha1_wasmplugin_proto_rawDesc = "" +
	"\n" +
	"$extensions/v1alpha1/wasmplugin.proto\x12\x1bhigress.extensions.v1alpha1\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xa9\x06\n" +
	"\n" +
	"WasmPlugin\x12\x10\n" +
	...
	"matchRules\x12P\n" +
	"\x16default_config_disable\x18g \x01(\v2\x1a.google.protobuf.BoolValueR\x14defaultConfigDisable\"\xae\x02\n" +
	"\tMatchRule\x12\x18\n" +
	...
	"\n" +
	"route_type\x18\x06 \x01(\x0e2&.higress.extensions.v1alpha1.RouteTypeR\trouteType\x12\x1a\n" +
	"\bconsumer\x18\a \x03(\tR\bconsumer\"A\n" +
	"\bVmConfig\x125\n" +
